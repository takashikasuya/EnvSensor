...
host = 'kasuya.hongo.wide.ad.jp'
port = 1883
prefix = "neo-rc.com/LODGE/raspi-box-002/Omron/Env/"
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: {} <mac address, mqtt_user, mqtt_pass>".format(sys.argv[0]))
        sys.exit(1)
    addr = sys.argv[1]
    # check device list file
    client = mqtt.Client(protocol=mqtt.MQTTv311)
    client.username_pw_set(sys.argv[2], password=sys.argv[3])
